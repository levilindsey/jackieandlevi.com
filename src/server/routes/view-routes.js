...
/**
 * Attaches a default route for the given app. This could either use templating with Jade or serve
 * a static index.html file, depending on the setup of the app.
 *
 * @param {Object} server
 * @param {string} appPath
 */
...
//  routeName = '/' + appName;
  ...
  indexFilePath =
      appUsesServerSideTemplating ? appPath + '/templates/index' : appPath + '/index.html';
